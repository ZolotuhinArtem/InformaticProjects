...
@ComponentScan(basePackages = {"com.zlthnrtm.article.model", "com.zlthnrtm.article.service", "com.zlthnrtm.article.repository"})
@EnableJpaRepositories(basePackages = {"com.zlthnrtm.article.jpa_repository"})
